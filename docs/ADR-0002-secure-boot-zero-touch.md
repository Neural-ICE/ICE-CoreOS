...
**BUSINESS prerequisites**: legal/operational items tracked **privately**, outside
this open-core repo.
...
- The OTA licensing/gating model is documented **privately** (out of this open-core repo).
