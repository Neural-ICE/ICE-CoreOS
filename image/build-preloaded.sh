...
# Volume sizing policy (Owner 2026-07-04): ALWAYS 20% margin on top of the content.
GROW=$(( SEED_BYTES + SEED_BYTES/5 + 4*1024*1024*1024 ))    # store+models + 20% + 4 GiB headroom
