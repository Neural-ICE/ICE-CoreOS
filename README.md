...
> can install it on a DGX Spark and inject their own SSH key. The Neural ICE appliance
> (ICE-AC1) is built from this same base by baking an operator key and adding a private
> app layer on top.
